<!DOCTYPE html>
  ...
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="ReBacklog">
  ...
  <body data-home-page="Home.html" data-home-page-title="Home" class="u-body u-xl-mode" data-lang="it">
    <section class="u-clearfix u-section-1" id="sec-5f31">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-image u-image-contain u-image-default u-preserve-proportions u-image-1" src="images/icon.jpg" alt="" data-image-width="128" data-image-height="128">
        <h1 class="u-text u-text-default u-text-1">Sign In</h1>
        <div class="u-form u-login-control u-form-1">
          <form action="#" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            ...
            <div class="u-align-center u-form-group u-form-submit u-label-top">
              <a href="#" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-50 u-btn-1">Login</a>
              <input type="submit" value="submit" class="u-form-control-hidden">
            </div>
            <input type="hidden" value="" name="recaptchaResponse">
          </form>
        </div>
        <a href="./signUp.php" class="u-btn u-btn-round u-button-style u-radius-50 u-btn-2">Non sei registrato? Registrati!</a>
      </div>
    </section>
  </body>
</html>